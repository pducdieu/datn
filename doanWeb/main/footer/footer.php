        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="gioithieu">
                        <h3 class="header text-uppercase font-weight-bold">Về Lộc Phát Computer</h3>
                        <a href="#">Giới thiệu về Lộc Phát Computer</a>
                        <a href="#">Tuyển dụng</a>
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="hotrokh">
                        ...
                        <a href="baohanh.php">Chính sách đổi trả</a>
                    </div>
                </div>
                <div class="col-md-3 col-xs-6">
                    <div class="lienket">
