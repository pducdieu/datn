                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <td>
                                        <a href="./xemdonhang.php?id=<?= $row['id'] ?> " class="btn btn-danger">Xem</a>
                                    </td>
                                    <td>
                                ...
                                <div class="col-12">
                                    <nav>
                                        ...
                                        <?php if($current_page -1 > 0) { ?>
                                            <li><a href="dathangnv.php?page=<?php echo $current_page -1 ?>">&laquo;</a></li>
                                            <?php } ?>
                                            <?php for($i=1; $i<=$page ;$i++) { ?>
                                                <li class="<?php echo ($current_page ==$i) ? 'active' : '' ?>"><a href="dathangnv.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                                              <?php  }?>
                                              
                                              <?php if($current_page +1 <= $page ) { ?>
                                            <li><a href="dathangnv.php?page=<?php echo $current_page +1 ?>">&raquo;</a></li>
                                            <?php } ?>
                                        </ul>
