            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="dathangnv.php">Quản lý đơn hàng</a>
                            </li>
                            
                            <li>
                                <a href="nvsanpham.php">Quản lý sản phẩm</a>
                            </li>

                            <li>
                                <a href="nvmenu_product.php">Quản lý danh mục sản phẩm</a>
                            </li>
                                ...
                                <div class="col-12">
                                    <nav>
                                        ...
                                        <?php if($current_page -1 > 0) { ?>
                                            <li><a href="nvsanpham.php?page=<?php echo $current_page -1 ?>">&laquo;</a></li>
                                            <?php } ?>
                                            <?php for($i=1; $i<=$page ;$i++) { ?>
                                                <li class="<?php echo ($current_page ==$i) ? 'active' : '' ?>"><a href="nvsanpham.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                                              <?php  }?>
                                              
                                              <?php if($current_page +1 <= $page ) { ?>
                                            <li><a href="nvsanpham.php?page=<?php echo $current_page +1 ?>">&raquo;</a></li>
                                            <?php } ?>
                                        </ul>
