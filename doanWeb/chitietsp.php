                        ...
                        <div class="row">
                            ...
                            <form method="GET" action="cart.php">
                                <div class="gia">
                                    ...
                                    <div class="tietkiem">Đơn giá: <b><?php echo number_format ($product['price']); ?> ₫</b>  </div> 
                                </div>
                                <div class="uudai my-3">
                                    <h6 class="header font-weight-bold">Khuyến mãi & Ưu đãi tại Lộc Phát Computer:</h6>
                                    <ul>
                                        <li><b>Mua với giá: </b><?php echo number_format ($product['price']); ?> đ</li>
                                ...
                                <div class="soluong d-flex">
                                    ...
                                    <div class="input-number input-group mb-3">
                                        ...
                                        <input type="number" name="quantity" value="1" min="1" max="<?php echo $slkho; ?>" class="soluongsp  text-center" >
                            ...
                            <div class="col-md-5">
                                <div class="thongtinsach">
                                    <ul>
                                        <li> <span class="header font-weight-bold">Khi mua tại Lộc Phát Computer quý khác sẽ được:</span></li>
